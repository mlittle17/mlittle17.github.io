...
function greeter(hour) {
    ...
    // conditional statement that is true if hour is greater than 0 and less than or equal to 11
    if (hour >= 0 && hour <= 11) {
        
        console.log("Good Morning!") // prints Good Morning to the console
    }
    // conditional statement that is true if hour is greater than 12 and less than or equal to 16
    else if(hour >= 12 && hour <= 16) {
        
        console.log("Good Afternoon!") // prints Good Afternoon to the console

    }
    // conditional statement that is true if hour is greater than 17 and less than or equal to 21
    else if(hour >= 17 && hour <= 21) {
        
        console.log("Good Evening!") // prints Good Evening to the console
    }
    // else statement that will run if all above statements are false
    else {
        console.log("Good Night!") // prints Good Night to the console
    }
